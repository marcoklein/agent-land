...
* [Ticket loop](ticket-loop.md) — the dogfooding heartbeat (concept): one stateless prompt that advances every ticket by exactly one step per tick, fresh context per step
