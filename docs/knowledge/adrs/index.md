...
* [007 — HTMX + Pico served locally](007-htmx4-pico-css-local.md) — **deprecated** for the engine in 016; re-adopted for the separate web-ui in [018](018-web-ui-separate-consumer.md)
...
* [012 — Styling via Pico classes](012-styling-pico-no-inline.md) — **deprecated** for the engine in 016; re-adopted for the separate web-ui in [018](018-web-ui-separate-consumer.md)
* [013 — Real-time agent UI (HTMX4 SSE)](013-real-time-agent-ui-htmx4-sse.md) — **deprecated**, web UI removed in 016; SSE remains deferred in 018
