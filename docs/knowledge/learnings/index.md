...
* [SSE over the hosted edge proxy](hosted-sse.md) — proxy buffering, heartbeats, header flush, and gapless replay/dedupe
* [Session lifecycle & redeploy resilience](session-lifecycle.md) — what survives a redeploy and how sessions recover
* [Idle sessions accumulate and overload the host](session-accumulation.md) — nothing stops an idle session; 161 containers drove load to ~795 and stalled deploys
