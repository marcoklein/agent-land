...
* [Scheduled maintenance](scheduled-maintenance-design.md) — weekly dep-bump + stale-PR triage workflow, human-gated and idempotent via branch/title latch and weekly marker comment
