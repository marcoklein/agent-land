...
* [Self-hosting sessions P1 — runtime seam](self-hosting-sessions-p1-seam-design.md) — runner protocol + `RemoteAgentHarness` behind the unchanged port; dial-out transport, entrypoint delivery, runner-owned spool
