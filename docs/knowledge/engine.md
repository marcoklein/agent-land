...
- **Playbooks** — bundles of skills, recipes, policies, and gates that encode a proven way of working. The [agent-land playbook](/dogfooding.md) is the first; playbooks speak the public API like any client.
