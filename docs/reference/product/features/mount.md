...
- See [engine.md](/reference/engine.md#capabilities-injected-at-session-creation) for the primitive spec.
...
[^archon]: [Inspiration from Archon](/reference/learnings/archon-inspiration.md) — idea #1, worktree isolation feeding Mount design
